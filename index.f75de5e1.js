...
document.addEventListener("click", (e)=>{
    ...
    if (e.target.closest(".wall")) {
        ...
        if (x < 0) x = 0;
        else if (x > wall.clientWidth - spider.clientWidth) x = wall.clientWidth - spider.clientWidth;
        if (y < 0) y = 0;
        else if (y > wall.clientHeight - spider.clientHeight) y = wall.clientHeight - spider.clientWidth;
